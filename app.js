...
(function () {
  ...
  function cleanScreen(s) {
    return ['journey', 'library', 'station', 'detail', 'pathways', 'assignments', 'assignment-program', 'assignment-details', 'assignment-rubric', 'assignment-release', 'assignment-ai', 'assignment-faq', 'starter', 'videos', 'readings', 'compare', 'reading', 'glossary', 'career', 'cards', 'review', 'sandbox', 'activity'].indexOf(s) >= 0 ? s : 'journey';
  }
